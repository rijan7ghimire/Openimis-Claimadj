...
export default function Queue() {
  ...
  return <div className="page">
    <div className="row between top mb">
      <div><div className="actor">Reviewer · worklist · <span className="std-tag partial">synthetic claim book</span></div><h1>Review queue</h1><p className="mute">The claims waiting for a Medical Officer. Today HIB picks a random 5 % sample; our layer ranks by suspicion and says why. Click a row to review it.</p></div>
    </div>
